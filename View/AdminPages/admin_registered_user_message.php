...
<head>
    ...
    <title>Registered user messages</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" type="text/css" media="screen" href="../css/admin_pages_css/admin_registered_user_message.css" />
    ...
    <div id="side-var-bar">
        ...
        <div class="messages_details_page-nav2">
            <a href="admin_unregistered_user_message.php">
                ...
                <span class="total-messages2">  <?php echo $total_ur_message; ?> </span>
            </a>
        </div>
    ...
    <div id="page-body-details">
        ...
        <div id="registered-user-messages">
            <div id="registered-user-messages-heading">
                <i class="fa fa-envelope"></i> Registered user messages
                 <span id="total-messages"><?php echo $total = mysqli_num_rows($result2) ?> </span>
            </div>
           ...
           foreach ($result2 as $key) {
            ...
            <div id="chat-boxes-contaier">
                ...
                <div id="chat-message-username"> <?php echo $key['name']; ?> :</div>
                <div id="user-message-date">  <?php echo $key['message_date']; ?> </div>
                <div id="user-message"><?php echo $key['message']; ?></div>
                <div id="user-details">
                    <div id="user-email"><i class="fa fa-envelope"></i> <?php echo $key['email']; ?> </div>
                    <div id="user-phone-number"><i class="fa fa-phone"> <?php echo $key['phone_number']; ?> </i></div>
